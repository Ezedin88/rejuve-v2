...
export default function ProductHero() {
    ...
    const { image, productName, product_home_price, short_description, price, clinic_price_id, home_price_id, product_clinic_price } = productData || {};
    const handleProductSelection = (product: currently_selected_product) => {
        dispatch({
